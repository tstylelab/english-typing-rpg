...
vm.runInNewContext(ts.transpile(region + '\nglobalThis.tune=getBattleTuning;globalThis.miss=getPre1BattleMissMultiplier;', { target: ts.ScriptTarget.ES2022 }), ctx);
...
assert.ok(app.includes('const missDamageMultiplier = isPre1LongTextBattle'));
