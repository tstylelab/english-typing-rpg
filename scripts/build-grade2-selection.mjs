...
const meaningForExample = {
  ...
  constantly: '絶えず・常に', demonstrate: '実験で証明する',
  focus: '最も重視する点', effective: '効果のある',
  income: '働いて得る収入', creature: '正体の分からない生き物',
  medical: '医療に関する', ingredient: '料理に使う材料',
  region: '一つの地域', assignment: '学校で出される課題',
  vehicle: '道路を走る車両', environmental: '環境に関する',
  positive: '前向きな', transfer: '患者を別の施設へ移す',
  impact: '大きな影響', expense: '仕事でかかった費用',
  mental: '精神的な', poverty: '貧しい状態',
  fund: '活動に使う資金', structure: '建物などの構造物',
  council: '市の議会', requirement: '応募に必要な条件',
  recover: '手術後に回復する', renew: '有効期限を更新する',
  determine: '検査して確かめる', struggle: '支払いに苦労する',
  household: '一つの世帯', luxury: 'ぜいたく品',
  session: '会議の一つの区切り', commit: '責任を持って取り組む',
  restore: '元の水位に戻す', contribution: '研究による貢献',
  authority: '承認する権限', checkup: '定期的な健康診断',
  status: '患者の現在の状態', alternative: '代わりになるもの',
  complaint: '店への苦情', applicant: 'その職への応募者',
  widespread: '広範囲に及ぶ', ideal: '最も適している',
  permanent: '永久に残る', vital: '生きるために極めて重要な',
  commute: '通勤する', substitute: '別のものの代用品',
  interfere: '作業を邪魔する', reminder: '忘れないための通知',
  exclusive: '会員だけが利用できる', protest: '計画に抗議する',
  argument: '人と人との口論', victim: '災害の被害者',
  Arctic: '北極の', nuclear: '原子力に関する',
  witness: '事件を目撃した人', prescription: '薬の処方箋',
  extreme: '非常に厳しい', resource: '利用できる資源',
  employment: '安定した雇用', consequence: '行動がもたらす結果',
  criminal: '犯罪を犯した人', procedure: '決まった手順',
  reputation: '店などの評判', dump: '廃棄物を投棄する',
  reduction: 'ごみなどの削減', reasonable: '費用の面で妥当な',
  definitely: '間違いなく', imply: '言外にほのめかす',
  stimulate: '経済を活性化する', accompany: '同時に起こる',
  confess: '自分の過ちを認める', fulfill: '責任を果たす',
